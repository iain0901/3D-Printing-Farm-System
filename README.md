...
- Public quote intake with optional customer model uploads, shared file-library storage, automatic model metadata estimates, operator quote review, quote-to-order conversion, and attached-model handoff into the production queue
