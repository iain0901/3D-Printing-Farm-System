...
- [ ] External clients and public quote forms use `Idempotency-Key` for retry-prone quote intake, customer quote decisions, order, quote conversion, queue, filament purchasing, and commerce import write APIs; the built-in public quote form and quote portal controls have been smoke-tested for generated idempotency headers.
