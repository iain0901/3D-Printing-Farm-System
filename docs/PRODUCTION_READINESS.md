...
- [ ] `/api/audit` shows failed TOTP enablement password-proof attempts as `auth.2fa_enable_failed` with workspace/operator context and no submitted passwords, TOTP secrets, or authenticator codes.
